...
Asm_IOINBYTE	Proc	uses edx port:word
		xor eax, eax
        xor edx, edx
		mov dx, port
		in al, dx
...
Asm_IOINWORD	Proc	uses edx port:word
		xor eax, eax
        xor edx, edx
		mov dx, port
		in ax, dx
...
Asm_IOINDWORD	Proc	uses edx port:word
		xor eax, eax
        xor edx, edx
		mov dx, port
		in eax, dx
...
Asm_IOOUTBYTE	Proc	uses edx port:word, value:byte
		xor eax, eax
        xor edx, edx
		mov dx, port
		mov al, value
...
Asm_IOOUTWORD	Proc	uses edx port:word, value:word
		xor eax, eax
        xor edx, edx
		mov dx, port
		mov ax, value
...
Asm_IOOUTDWORD	Proc	uses edx port:word, value:dword
		xor eax, eax
        xor edx, edx
		mov dx, port
		mov eax, value
