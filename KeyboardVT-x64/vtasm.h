...
extern "C" ULONG Asm_IOINBYTE(USHORT uPort);
extern "C" ULONG Asm_IOINWORD(USHORT uPort);
extern "C" ULONG Asm_IOINDWORD(USHORT uPort);
extern "C" VOID Asm_IOOUTBYTE(USHORT uPort, UCHAR uValue);
extern "C" VOID Asm_IOOUTWORD(USHORT uPort, USHORT uValue);
extern "C" VOID Asm_IOOUTDWORD(USHORT uPort, ULONG uValue);
...
extern "C" void Asm_Rdtsc(PULONG64 p_rax, PULONG64 p_rdx);
