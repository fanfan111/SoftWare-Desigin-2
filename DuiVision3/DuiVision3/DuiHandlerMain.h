...
public:
	...
	LRESULT OnDuiBtnSystemStart(UINT uID, CString strName, UINT Msg, WPARAM wParam, LPARAM lParam);
	...
	DUI_DECLARE_MESSAGE_BEGIN(CDuiHandlerMain)
		...
		DUI_CONTROL_NAMEMSG_MESSAGE(L"button.systemStart", MSG_BUTTON_DOWN, OnDuiBtnSystemStart)
